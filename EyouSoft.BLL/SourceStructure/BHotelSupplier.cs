...
{
    public class BHotelSupplier : BLLBase
    {
        private readonly EyouSoft.IDAL.SourceStructure.IHotelSupplier dal = EyouSoft.Component.Factory.ComponentFactory.CreateDAL<EyouSoft.IDAL.SourceStructure.IHotelSupplier>();
        ...
        public int Add(EyouSoft.Model.SourceStructure.MHotelSupplier model)
        {
            ...
            if (flg == 1)
            {
                ...
                {
                    EventTitle = "添加供应商酒店",
                    ModuleId = Model.EnumType.PrivsStructure.Privs2.供应商管理_酒店,
                    EventMessage = "添加供应商酒店，编号：" + model.Id + "。"
                };
        ...
        public int Update(EyouSoft.Model.SourceStructure.MHotelSupplier model)
        {
            ...
            if (flg == 1)
            {
                var log = new Model.CompanyStructure.SysHandleLogs
                {
                    EventTitle = "修改供应商酒店",
                    ModuleId = Model.EnumType.PrivsStructure.Privs2.供应商管理_酒店,
                    EventMessage = "修改供应商酒店，编号：" + model.Id + "。"
                };
                new SysHandleLogs().Add(log);
            }
