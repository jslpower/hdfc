...
namespace EyouSoft.Config
{
    ...
    public class DefaultConfigFileManager
    {
        ...
        {
            return (IConfigInfo)EyouSoft.Toolkit.SerializationHelper.Load(configtype, configfilepath);
        }
        ...
        {
            return EyouSoft.Toolkit.SerializationHelper.Save(configinfo, configFilePath);
        }
    }
