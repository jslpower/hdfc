...
namespace Web.Fin
{
    public partial class OtherPayAdd : EyouSoft.Common.Page.BackPage
    {
        ...
        private void PageInit(string id, string dotype)
        {
            ...
            if (id != "" && dotype != "add")
            {
                EyouSoft.BLL.FinStructure.BQiTaFuKuan qiTaFuKuanBll = new EyouSoft.BLL.FinStructure.BQiTaFuKuan();
                EyouSoft.Model.FinStructure.MQiTaFuKuan model = qiTaFuKuanBll.GetFinCope(id);
                if (model != null)
                {
        ...
        private string PageSave(string id, string dotype)
        {
            ...
            EyouSoft.Model.FinStructure.MQiTaFuKuan model = new EyouSoft.Model.FinStructure.MQiTaFuKuan();
            ...
            if (t)
            {
                ...
                switch (result)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case -1:
                        msg = UtilsCommons.AjaxReturnJson("0", "付款总登记和超过应付,添加失败");
                        break;
                    default:
                        break;
                }
            ...
            else
            {
                ...
                switch (result)
                {
                    ...
                    case 1:
                        ...
                        break;
                    case -1:
                        msg = UtilsCommons.AjaxReturnJson("0", "付款总登记和超过应付,修改失败");
                        break;
                    default:
                        break;
                }
        ...
        protected void PowerControl(string dotype)
        {
            ...
            {
                if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_新增) && dotype.Equals("add"))
                {
                    this.btn.Visible = false;
                }
                if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_修改) && dotype.Equals("update"))
                {
                    this.btn.Visible = false;
                }
            }
