<%@ Page Title="其它支出-财务管理" Language="C#" AutoEventWireup="true" CodeBehind="OtherPay.aspx.cs"
    Inherits="Web.Fin.OtherPay" MasterPageFile="~/MasterPage/Front.Master" %>
    ...
    <div class="mainbody">
        ...
        <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td>
                    <form id="frm" action="/Fin/OtherPay.aspx" method="get">
                    <div class="searchbox">
                        <label>
                            时间：</label>
                        ...
                        <label>
                            支出项目：</label>
                        <input type="text" class="inputtext" id="txtPayItem" name="txtPayItem" value="<%=EyouSoft.Common.Utils.GetQueryStringValue("txtPayItem")%>" />
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("a.show").click(function() {
                var that = $(this);
                var url = "/Fin/OtherPayAdd.aspx?dotype=show&";
            ...
            $("a.add").click(function() {
                var url = "/Fin/OtherPayAdd.aspx?dotype=add";
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "登记",
                    modal: true,
            ...
            $("a.modify").click(function() {
                var that = $(this);
                var url = "/Fin/OtherPayAdd.aspx?dotype=update&";
                var tid = that.parent().parent().attr("tid");
                Boxy.iframeDialog({
                    iframeUrl: url + "tid=" + tid,
                    title: "修改",
            ...
            $("a.del").click(function() {
                if (confirm("确认删除所选项?")) {
                    ...
                    $.newAjax({
                        type: "POST",
                        data: { "tid": tid },
                        url: "/Fin/OtherPay.aspx?act=areadel",
                        dataType: 'json',
