...
namespace Web.Fin
{
    public partial class OtherPay : EyouSoft.Common.Page.BackPage
    {
        ...
        protected void PageInit()
        {
            ...
            search.ShouZhiXingMu = Utils.GetQueryStringValue("txtPayItem");

            EyouSoft.BLL.FinStructure.BQiTaFuKuan bll = new EyouSoft.BLL.FinStructure.BQiTaFuKuan();
            IList<EyouSoft.Model.FinStructure.MQiTaFuKuan> list = bll.GetFinCopeList(CurrentUserCompanyID, pageSize, pageIndex, ref recordCount, search);
            //绑定数据
        ...
        protected string Delete()
        {
            ...
            if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_删除))
            {
        ...
        {
            if (!this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_栏目))
            {
                Utils.ResponseNoPermit(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_栏目, true);
            }
            add = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_新增);
            update = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_修改);
            del = this.CheckGrant(EyouSoft.Model.EnumType.PrivsStructure.Privs3.财务管理_其他支出_删除);
        }
        #endregion
    }
}
