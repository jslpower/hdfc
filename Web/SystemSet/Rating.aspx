<%@ Page Title="线路区域管理" Language="C#" MasterPageFile="~/MasterPage/Front.Master"
    AutoEventWireup="true" CodeBehind="Rating.aspx.cs" Inherits="Web.SystemSet.Rating" %>
    ...
    <div class="tablelist">
        <table width="100%" cellspacing="1" cellpadding="0" border="0">
            <tbody>
                ...
                <asp:Repeater runat="server" ID="rprList">
                    <ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        var LineManageList = {
            ...
            BindBtn: function() {
                ...
                LineManageList.ShowBoxy({ iframeUrl: "/SystemSet/RatingAdd.aspx?dotype=add", title: "新增线信用等级", width: "550px", height: "120px" });
                    return false;
                })
                $(".update_bar").click(function() {
                var ratingid = $(this).closest("tr").attr("data-id");
                LineManageList.ShowBoxy({ iframeUrl: "/SystemSet/RatingAdd.aspx?dotype=update&ratingid=" + ratingid, title: "修改线路区域", width: "550px", height: "120px" });
                    return false;
                })
                $(".delete_bar").click(function() {
                var ratingid = $(this).closest("tr").attr("data-id");
                var url = "/SystemSet/Rating.aspx?dotype=delete&ratingid=" + ratingid;
