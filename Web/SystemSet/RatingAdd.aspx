<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RatingAdd.aspx.cs" Inherits="Web.SystemSet.RatingAdd"
        ...
        <tbody>
            <tr class="odd">
                ...
                <td width="84%" bgcolor="#E3F1FC" class="pandl3">
                    <asp:TextBox CssClass="inputtext formsize100" ID="txtRatingName" name="txtRatingName"
                        runat="server"></asp:TextBox>
                    <span id="tip" class="errmsg" style="display: none">*客户信用等级名称</span>
                </td>
            </tr>
            <tr class="odd">
        ...
        var LineAdd = {
            ...
            BindBtn: function() {
                ...
                $("#<%=btn.ClientID %>").click(function() {
                    if ($("#<%=txtRatingName.ClientID %>").val() == "") {
                        $("#tip").show();
                        return false;
                    }
                    var ajaxUrl = "/SystemSet/RatingAdd.aspx?type=save&dotype=update&ratingid=" + '<%=Request.QueryString["ratingid"]%>';
                    LineAdd.GoAjax(ajaxUrl);
                    return false;
                })
                $("#<%=txtRatingName.ClientID %>").focus(function() {
                    $("#tip").hide();
                })
