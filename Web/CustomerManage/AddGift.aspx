<%@ Page Language="C#" MasterPageFile="~/MasterPage/Boxy.Master" AutoEventWireup="true"
    CodeBehind="AddGift.aspx.cs" Inherits="Web.CustomerManage.AddGift" Title="生日礼物" %>
        ...
        var AddGiftPage={
            BindBtn:function(){
                $("#<%=btn.ClientID %>").click(function(){
                    ...
                    var url="/CustomerManage/AddGift.aspx?dotype=save&userid="+'<%=Request.QueryString["userid"] %>'+"&giftid="+'<%=Request.QueryString["giftid"] %>';
                ...
                $(".update").click(function(){
                    ...
                    var url="/CustomerManage/AddGift.aspx?dotype=show&userid="+'<%=Request.QueryString["userid"] %>'+"&giftid="+giftid;
                    window.location.href=url;
                })
                $(".delete").click(function(){
                    var giftid=$(this).closest("tr").attr("data-id");
                    var url="/CustomerManage/AddGift.aspx?dotype=delete&userid="+'<%=Request.QueryString["userid"] %>'+"&giftid="+giftid;
            ...
            GoAjax: function(url) {
                ...
                $.newAjax({
                    ...
                    success: function(ret) {
                        if (ret.result == "1") {
                            parent.tableToolbar._showMsg(ret.msg, function() { location.href = "/CustomerManage/AddGift.aspx?dotype=show&userid="+'<%=Request.QueryString["userid"] %>'; });
                        }
                        else {
