<%@ Page Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true" CodeBehind="JingdianList.aspx.cs" Inherits="Web.CustomerManage.JingdianList" Title="景点" %>
...
<div class="mainbody">
        ...
        <div style="height: 30px;" class="lineCategorybox">
            <uc1:TableOption ID="TableOption1" runat="server" Type="jingdian" />
        </div>
        <div class="hr_10">
        </div>
        <div style="width: 99%;">
                    ...
                    <asp:Repeater runat="server" ID="RptList">
                        <ItemTemplate>
                            <tr class="<%# Container.ItemIndex % 2 == 0 ? "even" : "odd"%>">
                                ...
                                <td align="center">
                                    <a class="toolbar_add" href="javascript:;" data-id='<%#Eval("SpotId") %>'>
                                        <%#Eval("Name")%></a>
                                </td>
                                <td align="center">
        ...
        var JingdianPage={
            PageInit:function(){
                $("#liststyle").find("a[class='toolbar_add']").click(function(){
                    ...
                    JingdianPage.ShowBoxy({ iframeUrl: "/CustomerManage/Addjingdian.aspx?dotype=add"+"&contactId="+contactId, title: "生日礼物", width: "520px", height: "310px" });
                })
                tableToolbar.init({
