<%@ Page Language="C#" MasterPageFile="~/MasterPage/Front.Master" AutoEventWireup="true"
    CodeBehind="ZutuansheList.aspx.cs" Inherits="Web.CustomerManage.ZutuansheList"
    Title="组团社" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="mainbody">
        ...
        <div style="height: 30px;" class="lineCategorybox">
            <uc1:TableOption ID="TableOption1" runat="server" Type="zutuanshe" />
        </div>
        <div class="hr_10">
        </div>
        <div style="width: 99%;">
                    ...
                    <asp:Repeater runat="server" ID="RptList">
                        <ItemTemplate>
                            <tr class="<%# Container.ItemIndex % 2 == 0 ? "even" : "odd"%>">
                                ...
                                <td align="center">
                                    <a class="toolbar_add" href="javascript:;" data-id='<%#Eval("ContactId") %>'>
                                        <%#Eval("Name")%></a>
                                </td>
                                <td align="center">
        ...
        var YuangongPage={
            PageInit:function(){
                $("#liststyle").find("a[class='toolbar_add']").click(function(){
                    ...
                    YuangongPage.ShowBoxy({ iframeUrl: "/CustomerManage/Addzutuanshe.aspx?dotype=add"+"&contactId="+contactId, title: "生日礼物", width: "520px", height: "310px" });
                })
                tableToolbar.init({
