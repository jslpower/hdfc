...
{
    public partial class DinnerAdd : EyouSoft.Common.Page.BackPage
    {
        ...
        private void PageInit(string id, string dotype)
        {
            ...
            foreach (var item in values)
            {
                ...
                this.ddlCuisine.Items.Add(ddlItem);
            }
            this.ddlCuisine.Items.Insert(0, new ListItem("--请选择--", ""));


            if (id != "" && dotype != "add")
            {
                EyouSoft.BLL.SourceStructure.BRestaurantSupplier bll = new EyouSoft.BLL.SourceStructure.BRestaurantSupplier();
                EyouSoft.Model.SourceStructure.MRestaurantSupplier model = bll.GetModel(id);
                if (model != null)
                {
                    Province = model.ProvinceId.ToString();
                    City = model.CityId.ToString();
                    txtunitname.Value = model.UnitName;
                    ddlCuisine.SelectedValue = ((int)model.Cuisine).ToString();
        ...
        private string PageSave(string id, string dotype)
        {
            ...
            EyouSoft.BLL.SourceStructure.BRestaurantSupplier bll = new EyouSoft.BLL.SourceStructure.BRestaurantSupplier();
            EyouSoft.Model.SourceStructure.MRestaurantSupplier model = new EyouSoft.Model.SourceStructure.MRestaurantSupplier();
            ...
            model.Cuisine = (EyouSoft.Model.EnumType.SourceStructure.Cuisine)Utils.GetInt(Utils.GetFormValue(ddlCuisine.UniqueID));
            ...
            model.SupplierType = EyouSoft.Model.EnumType.CompanyStructure.SupplierType.餐饮;
