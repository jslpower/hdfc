<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Boxy.Master" AutoEventWireup="true"
    CodeBehind="ScenicAdd.aspx.cs" Inherits="Web.ResourceManage.ScenicAdd" EnableEventValidation="false" %>
    ...
    <div>
        <table width="970" border="0" align="center" cellpadding="0" cellspacing="1" style="margin-top: 10px;">
            ...
            <tr class="even">
                ...
                <th>
                    <span style="color: red">*</span>等级：
                </th>
                <td align="left">
                    <asp:DropDownList ID="ddlStar" name="ddlStar" valid="required|RegInteger" errmsg="请选择等级|请选择等级"
                        runat="server" CssClass="inputselect" />
                </td>
            </tr>
            <tr class="odd">
                        ...
                        <asp:Repeater ID="rpPic" runat="server">
                            <ItemTemplate>
                                <span class='upload_filename'><a href='<%#Eval("FilePath") %>' target="_blank">
                                    <%#Eval("FileName")%></a> <a href="javascript:void(0)" onclick="ScenicAddPage.RemoveFile(this)"
                                        title='删除附件'>
            ...
            <tr class="odd">
                ...
                <td colspan="3">
                    <textarea id="txtTourGuide" name="txtTourGuide" cols="45" rows="5" class="inputarea formsize600"
            ...
            <tr class="even">
                ...
                <td colspan="3" align="left">
                    旺季门市：
                    <input type="text" class="inputtext" id="txtStorePrice" runat="server" />
                    旺季折扣：
                    <input type="text" class="inputtext" id="txtWJPrice" runat="server" />
                    淡季门市：
                    <input type="text" class="inputtext" id="txtDJPrice" runat="server" />
                    淡季折扣：
                    <input type="text" class="inputtext" id="txtZKPrice" runat="server" />
                </td>
            </tr>
            <tr class="odd">
                <th height="60" align="center">
        ...
        var ScenicAddPage = {
            PageInit: function() {
                ...
                $("#<%=btn.ClientID %>").click(function() {
                    if (!ScenicAddPage.CheckForm()) {
                        return false;
                    }
                    var url = "/ResourceManage/ScenicAdd.aspx?dotype=" + '<%=Request.QueryString["dotype"]%>' + "&type=save&tid=" + '<%=Request.QueryString["tid"]%>';
                    ScenicAddPage.GoAjax(url);
                    return false;
                });
            },
            GoAjax: function(url) {
                ScenicAddPage.UnBind();
                $.newAjax({
                    type: "post",
                    cache: false,
                    url: url,
