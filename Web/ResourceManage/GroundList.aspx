<%@ Page Title="地接社-供应商管理" Language="C#" MasterPageFile="~/MasterPage/Front.Master"
        ...
        <div class="mainbody">
            ...
            <table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <div class="searchbox">
                            <form id="frm" action="/ResourceManage/GroundList.aspx" method="get">
                            <label>
                                省份：</label>
    ...
    <script type="text/javascript">
        $(function() {
            $("a.show").click(function() {
                var that = $(this);
                var url = "/ResourceManage/GroundAdd.aspx?dotype=show&";
            ...
            $("a.add").click(function() {
                var url = "/ResourceManage/GroundAdd.aspx?dotype=add";
                Boxy.iframeDialog({
                    iframeUrl: url,
                    title: "新增",
                    modal: true,
            ...
            $("a.modify").click(function() {
                var that = $(this);
                var url = "/ResourceManage/GroundAdd.aspx?dotype=update&";
                var tid = that.parent().parent().attr("tid");
                Boxy.iframeDialog({
                    iframeUrl: url + "tid=" + tid,
                    title: "修改",
