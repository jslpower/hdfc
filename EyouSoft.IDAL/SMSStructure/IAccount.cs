...
namespace EyouSoft.IDAL.SMSStructure
{
    ...
    public interface IAccount
    {
        ...
        /// <returns></returns>
        decimal GetAccountMoney(int companyId);
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        int GetAccountSMSNumber(int companyId);
        ...
        EyouSoft.Model.SMSStructure.AccountInfo GetAccountInfo(int companyId);
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        bool HasNoCheckPay(int companyId);
        ...
        /// <returns></returns>
        bool DeductAccountMoney(int companyId, string userId, decimal money, int smscount, string tempFeeTakeId, string sendTotalId);
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.SMSStructure.PayMoneyInfo> GetPayMoneys(int pageSize, int pageIndex, ref int recordCount, int companyId, string companyName, 
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        IList<EyouSoft.Model.SMSStructure.SendTotal> GetExpenseDetails(int pageSize, int pageIndex, ref int recordCount, int companyId);
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        EyouSoft.Model.SMSStructure.AccountExpenseCollectInfo GetAccountExpenseCollectInfo(int companyId);
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        bool SetAccountBaseInfo(int companyId);
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        bool IsExistsAccount(int companyId);
